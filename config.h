...
static const char dmenufont[]       = "Iosevka:style=Medium:size=10";
...
static const char *const autostart[] = {
  ...
  //  "volumeicon", NULL,
  //  "sh", ".fehbg", NULL, 
  //  "sh", "/home/mint/.config/rustyvibes/rustyvibes.sh", NULL, 
  "sh", "/home/kali/.local/bin/dwm-autostart.sh", NULL, 
  NULL /* terminate */
};
...
/* powermenu */
static const char *powermenu[] = { "/home/kali/.scripts/powermenu.sh", NULL };
...
static Key keys[] = {
  ...
  // powermenu
    ...
    // note
    { MODKEY, XK_n, spawn, SHCMD("qterminal -e ~/.scripts/notetaker.sh") },
    // File explorer
